...
import { ImageUploadPanel, ImageUploadTab } from './components/image-upload';
import {
  StrokeAppearancePanel,
  StrokeAppearanceTab,
} from './components/stroke-appearance';
import { StrokeSizePanel, StrokeSizeTab } from './components/stroke-size';
import {
  StrokeDirectionPanel,
  StrokeDirectionTab,
} from './components/stroke-direction';
import { ImageMaskingPanel, ImageMaskingTab } from './components/image-masking';
